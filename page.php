	...
	<section  class="slider">
        <ul id="slide-list">
          <li style="background-image: url('<?php echo ANPOL_THEME_URL; ?>img/1a.jpg') no-repeat; ">
            <a href="#slide1">
				<img src="<?php echo ANPOL_THEME_URL; ?>img/1a.jpg" 
				<?php if(get_bloginfo('language')=='pl-PL'):?>			  
					alt="Obsługa rachunkowo-ksiegowa"			  
				<?php else: ?>			  
          ...
          <li style="background: url('<?php echo ANPOL_THEME_URL; ?>img/2a.jpg') no-repeat; background-size: cover;">
            ...
            <a href="#slide2">
				<img src="<?php echo ANPOL_THEME_URL; ?>img/2a.jpg"  
				<?php if(get_bloginfo('language')=='pl-PL'):?>
					alt="Obsługa kadrowo-placowa"
				<?php else: ?>
					alt="HR services"
				<?php endif; ?>
			  >
           ...
           <li style="background: url('<?php echo ANPOL_THEME_URL; ?>img/3a.jpg') no-repeat; background-size: cover;">
            ...
            <a href="#slide3">
				<img src="<?php echo ANPOL_THEME_URL; ?>img/3a.jpg" 
				<?php if(get_bloginfo('language')=='pl-PL'):?>
					alt= "Rozliczenia projektów unijnych"
				<?php else: ?>
					alt="Settlement of EU projects "
				<?php endif; ?>
